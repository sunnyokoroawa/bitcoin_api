...
namespace Bitcoin.Core.Models.BitcoinCore
{
    ...
    public class BTCRPCRequest
    {
        public BTCRPCRequest(BTCRPCOperations method, object[] parameters)
            : this(method.ToString(), parameters)
        {

        }

        public BTCRPCRequest(string method, object[] parameters)
            : this()
        {
            Method = method;
            Params = parameters;
